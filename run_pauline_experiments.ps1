...
$experiments = @(
    ...
    @{ id = 4; args = "--policy CnnPolicy --lr 1.5e-4 --gamma 0.97 --batch-size 32 --epsilon-start 1.0 --epsilon-end 0.08 --epsilon-decay 0.15 --timesteps 15000" },
    ...
    @{ id = 9; args = "--policy MlpPolicy --lr 2.5e-4 --gamma 0.975 --batch-size 32 --epsilon-start 1.0 --epsilon-end 0.07 --epsilon-decay 0.18 --timesteps 15000" },
